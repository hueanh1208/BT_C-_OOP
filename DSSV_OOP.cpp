 ...
 DSSV ds;  char mssv [10];
  int chon;  
    while  (1) {
        ...
        case 2:ds.LietKe();
		         break;
		case 3: if (ds.GhiDSSV("e:/DSSV.bin")==1){
			        gotoxy(20,dong+so_item+2);
		 			cout << endl << "Da ghi DSNV thanh cong";
		 			Sleep (2000);
		 		}
				break;
		case 4: if(ds.LoadDSSV("e:/DSSV.bin")==1){
			        gotoxy(20,dong+so_item+2);
		...
		case 5: cout << "MSSV muon nhap diem : " ;
		        gets(mssv); ds.NhapDiem(mssv);
		         break;	
		case 6: cout<<"Nhap MSSV can xoa: ";
				gets(mssv); ds.XoaSV(mssv);
				break;  
